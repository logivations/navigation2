...
6. now adapt speed and steering angle
   ...
   2. if current speed is larger than max valid speed: **hold the current steering angle** (do not steer toward the bucket boundary), wait for deceleration before allowing steering into the next bucket
