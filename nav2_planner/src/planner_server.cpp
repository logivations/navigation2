...
PlannerServer::on_configure(const rclcpp_lifecycle::State & state)
{
  ...
  no_waiting_costmap_thread_ = std::make_unique<nav2::NodeThread>(no_waiting_costmap_ros_);
  no_go_areas_costmap_thread_ = std::make_unique<nav2::NodeThread>(no_go_areas_costmap_ros_);
