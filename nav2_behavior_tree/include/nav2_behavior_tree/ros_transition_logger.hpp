...
public:
    ...
    snapshot_interval_(snapshot_interval)
  {
    ...
    transition_pub_ = nav2::interfaces::create_publisher<nav2_msgs::msg::BehaviorTreeTransition>(
      node, "~/bt_transition", rclcpp::SensorDataQoS());
    transition_pub_->on_activate();

    snapshot_pub_ = nav2::interfaces::create_publisher<nav2_msgs::msg::BehaviorTreeSnapshot>(
      node, "~/bt_snapshot", rclcpp::QoS(1).transient_local());
...
private:
  ...
  nav2::Publisher<nav2_msgs::msg::BehaviorTreeTransition>::SharedPtr transition_pub_;
  nav2::Publisher<nav2_msgs::msg::BehaviorTreeSnapshot>::SharedPtr snapshot_pub_;
};
