...
: BtActionNode<nav2_msgs::action::DriveStraight>(xml_tag_name, action_name, conf)
{
  double dist;
...
void DriveStraightAction::on_tick()
{
...
BT_REGISTER_NODES(factory)
{
  ...
  factory.registerBuilder<nav2_behavior_tree::DriveStraightAction>("DriveStraight", builder);
}
